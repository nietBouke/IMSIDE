...
def tidal_module(self, tid_set):
    ...
    #define parameters
    #vertical visocisty
    if self.choice_viscosityv_ti == 'constant': tid_set['Av_ti'] += np.zeros(self.di[-1]) #do nothing, value is specified
    ...
    if self.choice_diffusivityv_ti == 'constant': tid_set['Kv_ti'] += np.zeros(self.di[-1]) #do nothing, value is specified
    ...
    #bottom slip 
    if self.choice_bottomslip_ti  == 'constant' : tid_set['sf_ti'] += np.zeros(self.di[-1]) #do nothing, value is specified
...
def tidjac_indv(self, tid_geg):
    ...
    for dom in range(self.ndom):     
        ...
        #term 1
        dt1_dsb1[:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real(utp_here * np.conj( dsdc2_here * self.g/tid_geg['omega']**2 * (detadx2_here/(2*self.dxn[dom]) + detadx_here/(self.dxn[dom]**2)) ) 
        ...
        dt1_dsb0[:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real( utp_here * np.conj(dsdc2_here * -2 * self.g/tid_geg['omega']**2 * detadx_here/(self.dxn[dom]**2)) 
                               + np.conj(utp_here) * (dsdc2_here * -2 * self.g/tid_geg['omega']**2 * detadx_here/(self.dxn[dom]**2))) * np.cos(nph_here*z_here)).mean(2)

        dt1_dsb_1[:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real(utp_here * np.conj(dsdc2_here * self.g/tid_geg['omega']**2 * (-detadx2_here/(2*self.dxn[dom]) + detadx_here/(self.dxn[dom]**2)))
                                + np.conj(utp_here) * dsdc2_here * self.g/tid_geg['omega']**2 * (-detadx2_here/(2*self.dxn[dom]) + detadx_here/(self.dxn[dom]**2))) * np.cos(nph_here*z_here)).mean(2)
                                                           
        dt1_dsn1[:,:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real( utp_here * np.conj(dsdc3_here * -nph_here * eta_here/(2*self.dxn[dom]) + dsdc4_here * -nph_here * self.g/tid_geg['omega']**2 /(2*self.dxn[dom]) * (detadx2_here + detadx_here/self.bn[dom])) 
        ...
        dt1_dsn0[:,:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real(    utp_here * np.conj(dsdc3_here * (- nph_here * detadx_here) + dsdc4_here * (-nph_here * self.g/tid_geg['omega']**2 * (detadx3_here + detadx2_here/self.bn[dom])))
        ...
        dt1_dsn_1[:,:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real( utp_here * np.conj(dsdc3_here * -nph_here * eta_here/(2*self.dxn[dom]) + dsdc4_here * -nph_here * self.g/tid_geg['omega']**2 /(2*self.dxn[dom]) * (detadx2_here + detadx_here/self.bn[dom])) 
        ...
        #term 2
        dt2_dsb1[:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real(utb_here * np.conj( dspdc2_here * self.g/tid_geg['omega']**2 * (detadx2_here/(2*self.dxn[dom]) + detadx_here/(self.dxn[dom]**2)) ) 
        ...
        dt2_dsb0[:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real( utb_here * np.conj(dspdc2_here * -2 * self.g/tid_geg['omega']**2 * detadx_here/(self.dxn[dom]**2)) 
                               + np.conj(utb_here) * (dspdc2_here * -2 * self.g/tid_geg['omega']**2 * detadx_here/(self.dxn[dom]**2))) * np.cos(nph_here*z_here)).mean(2)

        dt2_dsb_1[:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real(utb_here * np.conj(dspdc2_here * self.g/tid_geg['omega']**2 * (-detadx2_here/(2*self.dxn[dom]) + detadx_here/(self.dxn[dom]**2)))
                                + np.conj(utb_here) * dspdc2_here * self.g/tid_geg['omega']**2 * (-detadx2_here/(2*self.dxn[dom]) + detadx_here/(self.dxn[dom]**2))) * np.cos(nph_here*z_here)).mean(2)
                                                           
        dt2_dsn1[:,:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real( utb_here * np.conj(dspdc3_here * -nph_here * eta_here/(2*self.dxn[dom]) + dspdc4_here * -nph_here * self.g/tid_geg['omega']**2 /(2*self.dxn[dom]) * (detadx2_here + detadx_here/self.bn[dom])) 
        ...
        dt2_dsn0[:,:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real(    utb_here * np.conj(dspdc3_here * (- nph_here * detadx_here) + dspdc4_here * (-nph_here * self.g/tid_geg['omega']**2 * (detadx3_here + detadx2_here/self.bn[dom])))
        ...
        dt2_dsn_1[:,:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real( utb_here * np.conj(dspdc3_here * -nph_here * eta_here/(2*self.dxn[dom]) + dspdc4_here * -nph_here * self.g/tid_geg['omega']**2 /(2*self.dxn[dom]) * (detadx2_here + detadx_here/self.bn[dom])) 
        ...
        #term 3
        dt3_dsb1[:,self.di[dom]:self.di[dom+1]]  = 1/4*self.Lsc * (np.real(wt_here * np.conj(dstdz_dc2_here * self.g/tid_geg['omega']**2 * detadx_here * 1/(2*self.dxn[dom])) + np.conj(wt_here) * (dstdz_dc2_here * self.g/tid_geg['omega']**2 * detadx_here * 1/(2*self.dxn[dom])))* np.cos(nph_here*z_here) ).mean(-1)
        dt3_dsb_1[:,self.di[dom]:self.di[dom+1]] = 1/4*self.Lsc * (np.real(wt_here * np.conj(dstdz_dc2_here * self.g/tid_geg['omega']**2 * detadx_here *-1/(2*self.dxn[dom])) + np.conj(wt_here) * (dstdz_dc2_here * self.g/tid_geg['omega']**2 * detadx_here *-1/(2*self.dxn[dom])))* np.cos(nph_here*z_here) ).mean(-1)
        dt3_dsn0[:,:,self.di[dom]:self.di[dom+1]]= 1/4*self.Lsc * (np.real(wt_here * np.conj(- nph_here * eta_here * dstdz_dc3_here - nph_here * self.g/tid_geg['omega']**2 * (detadx2_here + detadx_here/self.bn[dom]) * dstdz_dc4_here ) \
...
def jaco_tidal(self, ans, tid_geg, indi, version):
    ...
    if version in ['D']: 
        ...
        jac[indi['xnr_mj'],indi['xnrm_m']] += jac[indi['xnr_mj'],indi['xnrm_m']] + (t1a[indi['j1'],indi['xr']]+t2a[indi['j1'],indi['xr']]+t3a[indi['j1'],indi['xr']])
        jac[indi['xnr_mj'],indi['xnr_m']]  += jac[indi['xnr_mj'],indi['xnr_m']] +  (t1b[indi['j1'],indi['xr']]+t2b[indi['j1'],indi['xr']])
        jac[indi['xnr_mj'],indi['xnrp_m']] += jac[indi['xnr_mj'],indi['xnrp_m']] + (t1c[indi['j1'],indi['xr']]+t2c[indi['j1'],indi['xr']]+t3c[indi['j1'],indi['xr']])
        
        jac[indi['xnr_mj2'],indi['xnrm_mk']] += jac[indi['xnr_mj2'],indi['xnrm_mk']] + (t1d[indi['k1'],indi['j12'],indi['xr2']]+t2d[indi['k1'],indi['j12'],indi['xr2']])
        jac[indi['xnr_mj2'], indi['xnr_mk']] += jac[indi['xnr_mj2'], indi['xnr_mk']] + (t1e[indi['k1'],indi['j12'],indi['xr2']]+t2e[indi['k1'],indi['j12'],indi['xr2']]+t3e[indi['k1'],indi['j12'],indi['xr2']])
        jac[indi['xnr_mj2'],indi['xnrp_mk']] += jac[indi['xnr_mj2'],indi['xnrp_mk']] + (t1f[indi['k1'],indi['j12'],indi['xr2']]+t2f[indi['k1'],indi['j12'],indi['xr2']])
