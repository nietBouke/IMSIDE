...
class mod1c_g4:
    def __init__(self, inp_constants, inp_phys, inp_geo, inp_forc):
        ...
        # unzip input        
        # =============================================================================
        self.g , self.Be, self.Sc, self.cv, self.ch, self.CD, self.r = inp_constants
        
        self.N, self.Lsc, self.nz, self.nt = inp_phys[0]
        self.Av_st, self.Kv_st, self.sf_st, self.rr_st, self.Kh_st = inp_phys[1]
        self.Av_ti, self.Kv_ti, self.sf_ti, self.rr_ti, self.Kh_ti = inp_phys[2]
        self.choice_bottomslip_st, self.choice_bottomslip_ti = inp_phys[3]
        self.M = self.N+1

        self.Hn, self.Ln, self.bsn, self.dxn = inp_geo
         
        self.Q, self.soc, self.sri = inp_forc[0]
        self.tid_comp, self.tid_per, self.a_tide, self.p_tide = inp_forc[1]
    ...
    from visualisation.plot_functions_v1 import plot_sst , prt_numbers , plot_transport, plot_next