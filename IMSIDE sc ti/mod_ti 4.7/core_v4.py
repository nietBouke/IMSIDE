...
class mod1c_g4:
    ...
    from visualisation.plot_functions_v1 import plot_sst , prt_numbers , plot_transport, plot_next, terms_vert, plot_Kp , plot_transport3