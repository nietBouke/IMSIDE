...
def geo_try1():
    ...
    Ln = np.array([100000,10000,10000,10000,10000,25000])
    bsn = np.array([1000,1000,1000,1000,1000,1000,1000*np.exp(10)])
    dxn= np.array([1000,500,500,500,500,500])
    Hn = np.array([10,10,8,12,10,10])
...
def geo_GUA1():
    ...
    Hn= np.array([7.1]*5)
    #Hn= np.array([7.1,7.1,7.1,5,7.1])
    
    return Hn, Ln, bsn, dxn

def geo_DLW1():
    
    Hn= np.array([7.4,7.4,7.4,7.4])
    
    Ln = np.array([60000,142000,13000,25000])
    bsn = np.array([200,500,41500,18000,18000*np.exp(10)])
    dxn= np.array([2000,1000,250,250])
