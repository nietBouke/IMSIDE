...
def geo_test1():
    ...
    ch_gegs['C1'] = { 'Name' : 'C1' ,
               ...
               'dx' :  np.array([1000], dtype=float)*1, #same length as L
               'Ut' : 1 ,
               'loc x=0' : 'j1' ,
               'loc x=-L': 'w1'
               } 
    ...
    ch_gegs['C3'] = { 'Name' : 'C3' ,
               'Hn' : np.array([8,10], dtype=float),
               'L'  : np.array([85000,15000], dtype=float),
               'b'  : np.array([1000,1000,1000], dtype=float), #one longer than L
               'dx' : np.array([500,500], dtype=float)*1, #same length as L
               'Ut' : 1 ,
               'loc x=0' : 's1' ,
               'loc x=-L': 'j1'
               }
