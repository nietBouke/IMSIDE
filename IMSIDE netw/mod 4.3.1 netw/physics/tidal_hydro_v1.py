...
def tide_calc(self):
    ...
    for key in self.ch_keys:  
        ...
        self.ch_pars[key]['r_t'] = (self.ch_pars[key]['Av_ti'] / (self.ch_pars[key]['sf_ti'] * self.ch_gegs[key]['Hn']))
        ...
        self.ch_pars[key]['r_t_dom'] = (self.ch_pars[key]['Av_ti'] / (self.ch_pars[key]['sf_ti'] * self.ch_pars[key]['H']))[np.newaxis,:,np.newaxis]
