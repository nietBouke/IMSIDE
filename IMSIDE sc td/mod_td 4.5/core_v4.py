...
class mod1c_g4:
    def __init__(self, inp_constants, inp_phys, inp_geo, inp_forc):
        ...
        self.N, self.Lsc, self.nz, self.nt, self.theta = inp_phys[0]
        ...
        self.T, self.DT = inp_forc[0]
        self.Q, self.soc, self.sri = inp_forc[1]
        self.tid_comp, self.tid_per, self.a_tide, self.p_tide = inp_forc[2]
